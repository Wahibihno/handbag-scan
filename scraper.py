...
# On réutilise cloudscraper juste pour passer la sécurité des images
scraper_img = cloudscraper.create_scraper()

#Setup file 
os.makedirs("data" , exist_ok= True)
csv_file = open('dataset_bag.csv', 'w', newline='', encoding='utf-8')
...
for page in range(1,5) :
    ...
    # On simule un utilisateur qui descend la page pour forcer les images à charger (Lazy Loading)
    print("Défilement de la page pour charger les images...")
    for i in range(5):
        driver.execute_script("window.scrollBy(0, 1500);")
        time.sleep(1) # Petite pause à chaque coup de molette
